...
A1_EIsurgPI <- unname(c(A1_EIsurg + A1_sesurg*qt(0.05, A1_n-2), A1_EIsurg + A1_sesurg*qt(0.95, A1_n-2)))
A1_EIfinalPI <- unname(c(A1_EIfinal + A1_sefinal*qt(0.05, A1_n-2), A1_EIfinal + A1_sefinal*qt(0.95, A1_n-2)))
A1_bestfit <- lsoda(y=A1_init, times=soltime, func = EqBW1, parms = c(A1_parameters,A1_EIsurg, A1_EIfinal))
A1_fitinf <- lsoda(y=A1_init, times=soltime, func = EqBW1, parms = c(A1_parameters,A1_EIsurgPI[1], A1_EIfinalPI[1]))
A1_fitsup <- lsoda(y=A1_init, times=soltime, func = EqBW1, parms = c(A1_parameters,A1_EIsurgPI[2], A1_EIfinalPI[2]))
...
A2_EIsurgPI <- unname(c(A2_EIsurg + A2_sesurg*qt(0.05, A2_n-2), A2_EIsurg + A2_sesurg*qt(0.95, A2_n-2)))
A2_EIfinalPI <- unname(c(A2_EIfinal + A2_sefinal*qt(0.05, A2_n-2), A2_EIfinal + A2_sefinal*qt(0.95, A2_n-2)))
A2_bestfit <- lsoda(y=A2_init, times=soltime, func = EqBW1, parms = c(A2_parameters,A2_EIsurg, A2_EIfinal))
A2_fitinf <- lsoda(y=A2_init, times=soltime, func = EqBW1, parms = c(A2_parameters,A2_EIsurgPI[1], A2_EIfinalPI[1]))
A2_fitsup <- lsoda(y=A2_init, times=soltime, func = EqBW1, parms = c(A2_parameters,A2_EIsurgPI[2], A2_EIfinalPI[2]))
...
A3_EIsurgPI <- unname(c(A3_EIsurg + A3_sesurg*qt(0.05, A3_n-2), A3_EIsurg + A3_sesurg*qt(0.95, A3_n-2)))
A3_EIfinalPI <- unname(c(A3_EIfinal + A3_sefinal*qt(0.05, A3_n-2), A3_EIfinal + A3_sefinal*qt(0.95, A3_n-2)))
A3_bestfit <- lsoda(y=A3_init, times=soltime, func = EqBW1, parms = c(A3_parameters,A3_EIsurg, A3_EIfinal))
A3_fitinf <- lsoda(y=A3_init, times=soltime, func = EqBW1, parms = c(A3_parameters,A3_EIsurgPI[1], A3_EIfinalPI[1]))
A3_fitsup <- lsoda(y=A3_init, times=soltime, func = EqBW1, parms = c(A3_parameters,A3_EIsurgPI[2], A3_EIfinalPI[2]))

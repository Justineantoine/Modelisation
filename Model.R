...
avE <- function(superposition = T, details = F)
{
  ...
  plot(soltime, R_EI-R_EE, type="l", ylim=c(-4100, 1000), xlab="Days", ylab="Delta energy (kJ/d)")
  lines(soltime, R_EIinf-R_EEinf, type="l", lty=2)
  lines(soltime, R_EIsup-R_EEsup, type="l", lty=2)
  abline(0, 0)
  title(main="Energy imbalance for WR")
  
  plot(soltime, S_EI-S_EE, type="l", ylim=c(-5000, 1000), xlab="Days", ylab="Delta energy (kJ/d)", col=2)
  lines(soltime, S_EIinf-S_EEinf, type="l", lty=2, col=2)
  lines(soltime, S_EIsup-S_EEsup, type="l", lty=2, col=2)
  abline(0, 0)
